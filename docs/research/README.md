...
For a species-specific task, read that profile and only the shared sections
needed for the task.
...
| Kingfishes complex or soft-bottom work | [Kingfishes complex](nc-shore-species-research.md#12-kingfishes-complex-evidence-profile) |
| Sheepshead structure work | [Sheepshead](nc-shore-species-research.md#13-sheepshead-evidence-profile) |
| Florida pompano southern-surf work | [Florida pompano](nc-shore-species-research.md#14-florida-pompano-evidence-profile) |

## Shared synthesis and decisions
...
| Approved and deferred research decisions | [Research decision register](nc-shore-species-research.md#22-research-decision-register) and [research complete versus deferred](nc-shore-species-research.md#23-research-complete-versus-deferred) |
| Source review | [Core regional sources](nc-shore-species-research.md#25-core-north-carolina-and-regional-sources) and the relevant species source section |

## References

The package retains one shared source inventory plus species-specific source
sections for [Spanish mackerel](nc-shore-species-research.md#26-spanish-mackerel-research-sources),
[red drum](nc-shore-species-research.md#27-red-drum-research-sources),
[bluefish](nc-shore-species-research.md#28-bluefish-research-sources),
[spotted seatrout](nc-shore-species-research.md#29-spotted-seatrout-research-sources),
[kingfish](nc-shore-species-research.md#30-kingfish-research-sources),
[sheepshead](nc-shore-species-research.md#31-sheepshead-research-sources), and
[Florida pompano](nc-shore-species-research.md#32-florida-pompano-research-sources).
